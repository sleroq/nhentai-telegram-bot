export default {
  greeting:                'Привет, ${uppercase(from.first_name)}\n<b>В этом боте присутствует 18+ контент. Нажимай эту кнопку только если ты старше 18!</b>',
  // # buttons:
  ...
  history_tip_desctiption: 'Это твоя история:',
  history_is_empty:        'Твоя история пуста!',

  next_page_tip_title:   'Следующая страница',
  next_page_tip_message: 'Чтобы просмотреть определенную страницу, вы можете *добавить /p*`n` к поисковому запросу, где `n` - номер страницы',

  sorting_by_popularity_tip_title: 'Для сортировки по популярности',
  sorting_by_new_tip_title:        'Для сортировке по новому',

  favorites:                 'Избранные!',
  favorites_tip_desctiption: 'Это твои избранные:',
  ...
  • Так же возможно загрузить картинки в .zip файле с помощью /zip команды. Например: \`/zip 234638\`
