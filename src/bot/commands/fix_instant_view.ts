...
// 	  try {
// 		await fixPage(pages[i])
// 	  } catch (error) {
// 		console.error('fixing page: ' + telegraphUrls[i], error)
// 		continue
// 	  }
// 	}
...
// async function fixPage(page: string, i: number, pages: string[], ctx: Context): Promise <string | undefined> {
//   const fixing_keyboard: InlineKeyboardButton[][] = [[]]
...
//   } catch (error) {
// 	console.log(
// 	  'error in uploading image happened ' +
// 	  error
// 	)
// 	i -= 1
// 	return undefined
...
//   // display the process:
//   fixing_keyboard[0].unshift({
// 	text:          i + 1 + '/' + pages.length + i18n.t('pages_fixed'),
...
// 	})
//   } catch (error) {
// 	throw new Verror('editMessageReplyMarkup while fixing pages', error)
//   }
