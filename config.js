{
  ...
  "//comment0": "This will be used to sign telegra.ph pages",

  "api_enabled": true,
  "//comment1": "show some stats as json on api/ page (details in: api.js, express.js)",

  "donation_wallets": "",
  "//comment2": "Add donation message to /help command with donation_wallets",
  ...
  "//comment3": "the number of pages in the manga required to add 'fix' button to message.",

  "maximum_codes_from_one_message": 30,

  "show_favorites_as_gallery": false,
  "search_sorting_by_default": "date",
  "//comment5": "date / popular",

  "search_appearance_by_default": "photo",
  "//comment6": "article (same as gallery) / photo",

  "random_localy_by_default": true,
  "//comment7": "about random loacaly https://telegra.ph/Settings-04-09",
